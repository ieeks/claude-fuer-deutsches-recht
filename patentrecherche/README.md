...
| --- | --- |
| Patentrecherche (`patentrecherche`, dieses Plugin) | [patentrecherche.zip](https://github.com/Klotzkette/claude-fuer-deutsches-recht/releases/latest/download/patentrecherche.zip) |
