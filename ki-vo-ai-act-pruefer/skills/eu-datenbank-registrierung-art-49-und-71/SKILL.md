...
description: "Anbieter oder Betreiber von Hochrisiko-KI fragt: In welcher EU-Datenbank muss ich mein KI-System registrieren und wann? Art. 49 und 71 KI-VO Registrierungspflichten. Pruefraster: Anbieter vor Inverkehrbringen Pflicht Art. 49 Abs. 1 oeffentliche Stellen als Betreiber vor Verwendung Art. 49 Abs. 3. Inhalt nach Anhang VIII Fristen Vertraulichkeit vs. oeffentliche Zugaenglichkeit Mindestfelder. Output: Registrierungs-Checkliste und Muster-Registrierungsdatensatz. Abgrenzung zu hochrisiko-konformitaetsbewertung-art-43-bis-49 (Konformitaetsbewertung) und hochrisiko-bestaetigt-end-to-end-roadmap (Gesamt-Roadmap)."
---
...
## Kommentarliteratur
- Wendehorst/Grinzinger, AI Act, 1. Aufl. 2024, Art. 49 Rn. 2: Anwendungsbereich und Pflichten.
