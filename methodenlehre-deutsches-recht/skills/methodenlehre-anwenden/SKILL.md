...
Dieser Skill verkörpert die deutsche juristische Methodenlehre als verbindliche Grundlage für jede rechtliche Bewertung in Cowork. Aktiviere ihn, sobald eine juristische Frage zu beantworten, ein Memo zu schreiben, ein Schriftsatz zu entwerfen oder eine Auslegungsentscheidung zu begründen ist.

## Wann dieser Skill greift

- Du bewertest eine juristische Frage und musst eine Anspruchsgrundlage prüfen.
- Du legst eine Norm aus und musst zwischen Wortlaut, Systematik, Historie und Telos abwägen.
- Du argumentierst mit einer Generalklausel (§ 138, § 242, § 826 BGB; § 1 GmbHG-Treuepflicht; „wichtiger Grund"; „Treu und Glauben") und musst die Auffang-Stellung begründen.
- Du strukturierst ein Memo oder einen internen Vermerk.
- Du musst eine richterliche Rechtsetzung oder ergebnisorientierte Auslegung offenlegen.
...
- **Keine scheinbaren Auslegungsregeln** als tragende Begründung: „Ausnahmen sind eng auszulegen", „im Zweifel für den Schuldner" (außerhalb gesetzlich geregelter Fälle), „AGB-Klauseln sind kundenfreundlich auszulegen" (pauschal), „Strafgesetze sind eng auszulegen" (jenseits Art. 103 II GG / § 1 StGB) — solche Topoi dürfen genannt werden, aber **nie als tragende Begründung**, sondern nur als Hinweis auf eine darunterliegende Wertentscheidung, die separat über Wortlaut, System, Historie und Telos zu rechtfertigen ist.
...
- **Keine verdeckte Ergebnisorientierung** — Wertentscheidungen sind offenzulegen.
...
- **`zitierweise-deutsches-recht`** — Jede Aussage wird nach der Hauszitierweise belegt.
- Alle übrigen Klotzkette-Rechtsgebiet-Plugins (vertragsrecht, datenschutzrecht, arbeitsrecht, gesellschaftsrecht, ...) setzen diese Methodenlehre voraus. Wer nur die Rechtsgebietsplugins lädt, bekommt die Methodik implizit über deren CLAUDE.md-Verweise — wer sie explizit als eigenes Plugin lädt, macht die Methodik zur ausdrücklichen Pflicht für jede Antwort.
