...
Den Deaktivierungs-Arbeitsablauf aus dem `skill-manager`-Referenz-Skill ausführen:
...
3. **Wenn letzte Aktion ist `disable`:** „Dieser Skill ist bereits deaktiviert. Reaktivieren? (ja / nein)" — bei ja Reaktivierungs-Arbeitsablauf ausführen.
...
> Detaillierte Deaktivierungs-, Deinstallations- und Reaktivierungs-Arbeitsabläufe liegen im `skill-manager`-Referenz-Skill — vor substanzieller Arbeit laden.
