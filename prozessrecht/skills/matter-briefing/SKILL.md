...
1. **Mandatsdaten laden:** `matters/[slug]/matter.md` und `matters/[slug]/history.md` einlesen.
...
3. **Entwicklungen seit letztem Update:**
   - Letzte Eintrag in history.md identifizieren
...
- **Veraltete matter.md:** Ohne regelmäßige Updates per `/mandat-update` liefert das Briefing einen falschen Stand; nach jeder Entwicklung updaten.
