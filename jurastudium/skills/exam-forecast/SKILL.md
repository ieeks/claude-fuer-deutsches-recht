...
description: >
  ...
  „exam-forecast" oder „worauf soll ich mich konzentrieren".
language: de
...
**Verknüpfte Skills:**
→ /jurastudium:study-plan (Prognose in Lernplan übertragen)
→ /jurastudium:bar-prep-questions --bundesland [X] [Rechtsgebiet]
```
