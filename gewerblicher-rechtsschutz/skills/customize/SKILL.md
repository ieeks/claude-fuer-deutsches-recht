...
description: >
  ...
  das gesamte cold-start-interview erneut auszuführen.
language: de
triggers:
...
Konfiguration aus `~/.claude/plugins/config/claude-fuer-deutsches-recht/gewerblicher-rechtsschutz/CLAUDE.md` lesen. Falls Platzhalter vorhanden: auf `cold-start-interview` hinweisen.
...
|---|---|
| Durchsetzungsstrategie von „ausgewogen" auf „offensiv" | cease-desist-Skill senkt Schwelle für Abmahnempfehlung |
| Neuer Genehmiger | alle Genehmigungsgates aktualisiert |
| Neues Schutzrecht | portfolio-Skill fügt Fristen automatisch hinzu |
| OSS-Richtlinie verschärft | oss-review-Skill verwendet neue Whitelist |
