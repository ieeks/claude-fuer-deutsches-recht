...
- Konkrete Formulierungsänderung vorschlagen (Ausgangspunkt für `/policy-redraft`)
...
**Eingabe:** `/regulatorisches-recht:policy-diff MaRisk-AT-4.3.2-Novelle-2023`
...
**Nächster Schritt:** `/regulatorisches-recht:policy-redraft` für den vollständigen Neufassungsentwurf.
