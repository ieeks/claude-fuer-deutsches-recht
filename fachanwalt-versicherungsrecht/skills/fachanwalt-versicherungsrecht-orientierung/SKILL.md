...
BGH, Urt. v. 20.04.2022 — **IV ZR 295/20**, NJW 2022, 1806 Rn. 18: Die VVG-Reform 2008 hat das Versicherungsvertragsrecht grundlegend neu ausgerichtet; Kernelemente sind verschärfte Informationspflichten nach §§ 6 ff. VVG, Wegfall der Alles-oder-nichts-Regelung bei Obliegenheitsverletzungen (§ 28 VVG), und Stärkung des Widerrufsrechts des Versicherungsnehmers nach §§ 8, 9 VVG.

BGH, Urt. v. 26.03.2014 — **IV ZR 422/12**, NJW 2014, 1799 Rn. 15: Versicherungsverträge unterliegen der AGB-Kontrolle nach §§ 305 ff. BGB; AVB-Klauseln, die typischerweise versicherbare Risiken ausschließen oder den Versicherungsschutz unangemessen einschränken, können nach § 307 BGB unwirksam sein; Maßstab ist das berechtigte Interesse eines durchschnittlichen Versicherungsnehmers.

BGH, Urt. v. 16.05.2018 — **IV ZR 334/16**, NJW 2018, 2318 Rn. 12: Im Versicherungsrecht gilt der BGH IV. Zivilsenat als zuständiger Leitsenat; grundsätzliche Fragen des VVG werden dort entschieden; bei Kfz-Versicherung ist daneben der VI. Zivilsenat (Deliktsrecht) zuständig.
...
- Prölss/Martin, VVG, 31. Aufl. 2021: Standardkommentar VVG mit vollständiger Kommentierung aller Spartenkapitel.
- Langheid/Wandt, MüKo VVG, 3. Aufl. 2022: Wissenschaftliche Kommentierung; besonders ausführlich zu AVB-Auslegung, Beweislast, Rechtsprechungsübersicht.
- Beckmann/Matusche-Beckmann, Versicherungsrechts-Handbuch, 3. Aufl. 2015: Fachanwalts-Handbuch nach Sparten; D&O, Cyber, Lebens-, BU-, Krankenversicherung.
- BeckOK VVG (laufend aktualisiert): Online-Kommentar; aktuellste Rechtsprechung direkt verlinkt.
...
| Widerruf (fehlerhafte Belehrung) | kein Erlöschen | BGH IV ZR 73/13 |
