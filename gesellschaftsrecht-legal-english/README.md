...
- dann `16` und `18` bis `22` für die Multi-Format-Materialien (WhatsApp-Thread, Cap-Table-Excel, Notar-Memo, Whiteboard, Investor-Email- und WhatsApp-Screenshot) sowie `chats/` für Slack-Thread und WhatsApp je als eigenes Dokument,
